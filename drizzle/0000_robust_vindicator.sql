...
CREATE TYPE "public"."channel_type" AS ENUM('baileys', 'cloud_api');--> statement-breakpoint
CREATE TYPE "public"."connection_status" AS ENUM('disconnected', 'connecting', 'needs_qr', 'connected', 'error');--> statement-breakpoint
CREATE TYPE "public"."conversation_status" AS ENUM('open', 'needs_human', 'closed');--> statement-breakpoint
...
CREATE TABLE "business_config" (
	...
	"llm_provider" "llm_provider" DEFAULT 'anthropic' NOT NULL,
	"llm_model" text,
